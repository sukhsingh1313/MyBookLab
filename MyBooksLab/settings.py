...
SECRET_KEY = 'django-insecure-=0fa*7ke8lqc41xuj-v=ef^eka&&m#9isjlcf&u0vwy=rc1^g@'
...
WSGI_APPLICATION = 'MyBooksLab.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'laja dgzy wvtf mwqz'  # no spaces
