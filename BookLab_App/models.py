...
from django.contrib.auth.models import User   # <- this is missing in your code
...
# ✅ PaymentProof ko alag model banake yaha define karo
class PaymentProof(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    book = models.ForeignKey(BooksLibrary, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"{self.user.username} - {self.book.title} - {self.utr_number}"
